...
Takes a raw Claude Code session log and produces a realistic terminal screencast showing how Claude worked — with tool calls, file edits, bash commands, and action captions. All logs undergo basic sanitization to detect sensitive data (API keys, tokens, passwords) before rendering.
